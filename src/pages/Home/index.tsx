  ...
  return (
    <>
      ...
      <a target="_blank" href="https://github.com/diegoHDCz">
        ...
        <a target="_blank" href="https://www.linkedin.com/in/diego-czajka-6a82191b2/">
          <SiLinkedin size={24} />
        </a>

        <a target="_blank" href="https://api.whatsapp.com/send?phone=45984090113&text=Olá, vamos falar de desenvolvimento?">
          <SiWhatsapp size={24} />
        </a>
      </div>
      <Skills />
